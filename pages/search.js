      ...
      <InputContainer>
        <FromToIcons>
          {/* <Circle src="https://img.icons8.com/ios-filled/50/9CA3AF/filled-circle.png"/>
                <Line src="https://img.icons8.com/ios/50/9CA3AF/filled-circle.png"/>
        ...
        <PlusIcon src="https://img.icons8.com/ios/50/00" />
      </InputContainer>
      <SavedPlaces>
...
bg-black text-white text-center mt-2 mx-4 px-4 py-3 text-2xl cursor-pointer rounded
`;
